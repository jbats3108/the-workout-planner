...
### Non-obvious notes
- HTTP request/response boundaries use **Spatie Laravel Data** under `App\{Domain}\Data\...` (see `docs/adr/0001-spatie-laravel-data-http-boundaries.md`). Prefer those over `$request->validate()` or ad-hoc Inertia prop arrays.

...
9. **Plate calculator UI** — plate profile + nearest loadable (schema exists; UI deferred)
10. **Flaky-network drafts** — best-effort offline/queue for player logging (later)
